...
var Profile = exports.Profile = _wrapComponent('Profile')(function (_React$Component) {
  ...
  _createClass(Profile, [{
    ...
    value: function render() {
      ...
      var bio = isLoading ? 'SomeBio...' : this.state.userData.name;
      var friends = isLoading ? [] : this.state.userData.friends;
      var profilePicture = isLoading ? null : _react3.default.createElement('img', { src: this.state.userData.profilePictureUrl, alt: '' });
